...
Примеры:
  ...
  python test_all_mtf_combinations.py --symbol ETHUSDT --days 60
    ...
    parser.add_argument("--conf-1h", type=float, default=0.50,
                       help="Порог уверенности для 1h модели (по умолчанию 0.50)")
    parser.add_argument("--conf-15m", type=float, default=0.35,
                       help="Порог уверенности для 15m модели (по умолчанию 0.35)")
